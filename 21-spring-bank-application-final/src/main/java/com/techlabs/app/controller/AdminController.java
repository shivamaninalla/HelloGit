...
//	}
	...
	public ResponseEntity<String> getUserById(@PathVariable (name = "userId") long userId) {
		return new ResponseEntity<String>(bankService.getEmailByID(userId),HttpStatus.OK);
	}
